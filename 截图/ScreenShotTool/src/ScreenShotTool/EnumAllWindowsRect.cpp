...
EnumAllWindowsRect::EnumAllWindowsRect(void)
{
}
...
// DateTime:  [7/15/2016]
//************************************
void EnumAllWindowsRect::EnumAllWindows()
{
    ClearAllWindows();
...
bool EnumAllWindowsRect::GetRect(const POINT& point, RECT& rect)
{
...
// DateTime:  [7/15/2016]
//************************************
void EnumAllWindowsRect::GetAllWindowsRect(vector<RECT>& rects)
{
    vector<WindowRect>::iterator iter = m_vectWindowsRect.begin();
    while (iter != m_vectWindowsRect.end() )
    {
...
// DateTime:  [7/15/2016]
//************************************
void EnumAllWindowsRect::EnumWindowsCtrl()
{
    vector<WindowRect>::iterator iter = m_vectWindowsRect.begin();
    while (iter != m_vectWindowsRect.end() )
    {
...
// DateTime:  [7/15/2016]
//************************************
void EnumAllWindowsRect::EnumAllCtrl(WindowRect& win)
{
...
// DateTime:  [7/15/2016]
//************************************
void EnumAllWindowsRect::ClearAllWindows()
{
